...
/*
		...
		$contato = Contato::model()->findByPk($model->idContato);
*/
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Endereco']) && isset($_POST['Contato']) && isset($_POST['Filial'])){
			...
			try{
				...
				if($model->save()){
					$transaction->commit();
					$this->redirect(array('view','id'=>$model->idFilial));	
				}
			}
			catch(Exception $e)
			{	
	 ...
	 * @param Filial $model the model to be validated
	 */
